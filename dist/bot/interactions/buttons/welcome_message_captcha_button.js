...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const guild = discord_client_js_1.client.guilds.cache.get(bot_guild_id);
        const member = await guild.members.fetch(interaction.user.id).catch(() => null);
        if (!(member instanceof discord_client_js_1.Discord.GuildMember)) {
        ...
        if (!(user_from_welcome_message instanceof discord_client_js_1.Discord.User)) {
        ...
        await (0, utilities_1.Timer)(1_000);
...
//# sourceMappingURL=welcome_message_captcha_button.js.map