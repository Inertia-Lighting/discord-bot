...
module.exports = {
    ...
    async execute(interaction) {
        if (interaction.isAutocomplete()) {
            ...
            const qs_topics = (await mongo_js_1.go_mongo_db.find(process.env.MONGO_DATABASE_NAME, process.env.MONGO_QUICK_SUPPORT_TOPICS_COLLECTION_NAME, {}));
            ...
            for (const qs_topic of qs_topics) {
                ...
                for (const searchable_query of qs_topic.searchable_queries) {
                    similarity_score_total += (0, string_similarity_1.compareTwoStrings)(search_query, searchable_query);
                }
                similarity_score_total += (0, string_similarity_1.compareTwoStrings)(search_query, qs_topic.title) * 1.20; // multiplied for weighted value
...
//# sourceMappingURL=quick_support.js.map