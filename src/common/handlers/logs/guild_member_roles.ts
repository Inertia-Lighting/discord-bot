...
async function guildMemberRolesAddedLogger(old_member: Discord.GuildMember, new_member: Discord.GuildMember) {
...
async function guildMemberRolesRemovedLogger(old_member: Discord.GuildMember, new_member: Discord.GuildMember) {
    if (!(old_member instanceof Discord.GuildMember))
...
export { guildMemberRolesAddedLogger, guildMemberRolesRemovedLogger };
