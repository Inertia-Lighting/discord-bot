...
export async function purgeModerationActions(interaction: Discord.ChatInputCommandInteraction) {
            ...
            .editReply({
                embeds: [
                    CustomEmbed.from({
                        ...
                        description:
                            'Please inform my developers that an error occurred while clearing moderation actions from the database!',
                    }),
                ],
            })
            .catch(console.warn);
