...
const new_server_member_role_ids = (process.env.BOT_SERVER_MEMBER_AUTO_ROLE_IDS as string).split(',');
const new_to_the_server_role_ids = (process.env.BOT_NEW_TO_THE_SERVER_AUTO_ROLE_IDS as string).split(',');
