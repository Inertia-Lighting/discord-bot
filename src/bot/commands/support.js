            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        ...
                        '\`   \` *( yes | maybe | idk | no )*',
                        '',
                        '\`(4)\` **Did you publish your game?**',
                        '\`   \` *( yes | idk | no )*',
                        '\`   \` Watch [this](https://inertia.wtf/kvck4ln9y0a) to see how to publish your game.',
                        '\`   \` Or, simply press \`[ALT] + [P]\` to publish your game.',
                        '\`   \` After publishing your game, you must restart roblox studio completely.',
                        '',
                        '\`(5)\` **Did you enable HTTP Requests?**',
                        '\`   \` *( yes | idk | no )*',
                        '\`   \` Take a look at [this](https://inertia.wtf/kvcihjnz10a) to learn how to enable HTTP Requests.',
                        '',
                        '\`(6)\` **Did you enable Studio Access to API Services?**',
                        '\`   \` *( yes | idk | no )*',
                        '\`   \` Take a look at [this](https://inertia.wtf/kvcihjnz10a) to learn how to enable Studio Access to API Services.',
                        '',
                        '\`(7)\` **Have you configured your Identity Token yet?**',
                        '\`   \` *( yes | idk | no )*',
                        '\`   \` Take a look at [this](<https://discord.com/channels/601889649601806336/811341531784413235>) to learn how to configure your Identity Token.',
                        '',
                        '\`(8)\` **We need you to do the following:**',
                        ...
                        '\`   \` Modify your \`Output\` settings to be the same as [this](https://inertia.wtf/RobloxStudioBeta_LNje9Lvzhs.mp4).',
                        ...
                        '',
                        '\`(9)\` **What are you having issues with?**',
            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        ...
                        '\`   \` Example: unknown',
                        '',
                        '\`(2)\` **What is your desired Roblox account?**',
                        '\`   \` *( profile url | roblox id )*',
                        '\`   \` Example: roblox.com/users/2010759283/profile',
                        '\`   \` Example: 2010759283',
                        '',
                        '\`(3)\` **What is your current Discord account?**',
                        '\`   \` *( @mention#0001 | discord id | unknown )*',
                        '\`   \` Example: <@!163646957783482370>',
                        '\`   \` Example: 163646957783482370',
                        '\`   \` Example: unknown',
                        '',
                        '\`(4)\` **What is your desired Discord account?**',
