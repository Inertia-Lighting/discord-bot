            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        ...
                        '\`   \` *( yes | kinda | maybe | no )*',
                        '',
                        '\`(3)\` **[Published Game](https://inertia.wtf/kvck4ln9y0a):**',
                        '\`   \` Did you publish your game using \`[ALT] + [P]\`?',
                        '\`   \` *( yes | idk | no )*',
                        '',
                        '\`(4)\` **[HTTP Requests Enabled](https://inertia.wtf/kvcihjnz10a):**',
                        '\`   \` Did you enable HTTP Requests in your game?',
                        '\`   \` *( yes | idk | no )*',
                        '',
                        '\`(5)\` **[Studio API Services Enabled](https://inertia.wtf/kvcihjnz10a):**',
                        '\`   \` Did you enable Studio Access to API Services in your game?',
                        '\`   \` *( yes | idk | no )*',
                        '',
                        '\`(6)\` **[Studio Output](https://inertia.wtf/ktudeh32f9a):**',
