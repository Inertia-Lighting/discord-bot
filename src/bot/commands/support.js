            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        ...
                        '',
                        '\`(5)\` **Did you enable HTTP Requests and Studio Access to API Services?**',
                        '\`   \` *( yes | idk | no )*',
                        '\`   \` Watch [this](https://inertia.wtf/kvcihjnz10a) to learn how to enable HTTP Requests and Studio Access to API Services.',
                        '',
