...
const support_categories = new Discord.Collection([
    {
            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        ...
                        '- **[Published Game](https://inertia.wtf/kvck4ln9y0a):** ( yes | idk | no )',
                        '- **[HTTP Requests Enabled](https://inertia.wtf/kvcihjnz10a):** ( yes | idk | no )',
                        '- **[Studio API Services Enabled](https://inertia.wtf/kvcihjnz10a):** ( yes | idk | no )',
                        '- **[Studio Output](https://inertia.wtf/ktudeh32f9a):** ( screenshot \"Play Here\" output after using the products )',
                        '- **Issue Encountered:** ( fully describe the issues you are having )',
                        '',
                        '**Follow the instructions properly or your ticket will be ignored!**',
                        '*Once you are done with the instructions, click the button below*',
                    ].join('\n'),
                }),
            ],
        },
            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        ...
                        '- **Current Roblox Account:** ( copy the URL for the profile page of the account | n/a )',
                        '- **Old Discord Account:** ( @mention#0001 | discord id | n/a )',
                        '- **Current Discord Account:** ( @mention#0001 | discord id | n/a )',
            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        ...
                        '- **Reason:** ( re-linking account | gifting products | other, please specify )',
                        '- **New Roblox Account:** ( copy the URL of the profile page for the account | n/a )',
                        '- **New Discord Account:** ( @mention#0001 | discord id | n/a )',
                        '',
                        '**Follow the instructions properly or your ticket will be ignored!**',
                        '*Once you are done with the instructions, click the button below*',
                    ].join('\n'),
            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        ...
                        '- **Proof Of Purchase(s):** ( screenshot your roblox [transactions](https://www.roblox.com/transactions) or paypal receipt )',
            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        ...
                        '- **Group Description:**',
                        '- **Group Member Count:**',
                        '- **Group Links ( discord, website, etc ):**',
        ...
        description: 'Simple (non-tech support) questions can be asked here.',
        qualified_support_role_ids: [
            ...
            embeds: [
                new Discord.MessageEmbed({
                    ...
                    description: [
                        '**Fill out the template shown below.**',
                        '',
                        '- **Question:** ( fully type out your question )',
                        '',
                        '**Follow the instructions properly or your ticket will be ignored!**',
                        '*Once you are done with the instructions, click the button below*',
                    ].join('\n'),
