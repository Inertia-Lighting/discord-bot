...
module.exports = {
    ...
    async execute(message, args) {
        ...
        try {
            ...
            console.trace(error);
            message.reply('Something went wrong while updating the new database, please check the console!').catch(console.warn);
            return;
        }

        message.reply('The new database was updated!').catch(console.warn);
    },
};
